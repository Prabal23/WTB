...
class CommentPage extends StatefulWidget {
  final feedId;
  final index;
  CommentPage(this.feedId, this.index);
  @override
...
class _CommentPageState extends State<CommentPage> {
  ...
  Future commentSend(index) async {
    ...
    if (res.statusCode == 200) {
      if (commentList.length != 0 && postReplyList.length != 0) {}
      commentList.removeAt(commentList.length - 1);
      postReplyList.removeAt(postReplyList.length - 1);
      comEditor.text = "";
      setState(() {
      ...
      comEditor.text = "";
      postReplyList.removeAt(commentList.length - 1);
      commentList.removeAt(commentList.length - 1);
  ...
  Future deleteStatus(int id, index) async {
    ...
    if (body == 1) {
      setState(() {
        ...
        postComCount[widget.index]['count'] -= 1;
        //isDeleted.add("$id");
        postReplyList.removeAt(widget.index);
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        //     backgroundColor: Colors.white,
                        //     backgroundImage:
                        //         widget.comList[index]['pic'] == "" ||
                        //                 widget.comList[index]['pic'] == null
