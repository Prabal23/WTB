...
List profileReplyList = [];

class ProfileCommentPage extends StatefulWidget {
  final feedId;
  final index;
  ProfileCommentPage(this.feedId, this.index);
  @override
  _CommentPageState createState() => _CommentPageState();
}

class _CommentPageState extends State<ProfileCommentPage> {
  var comList;
  var userData;
...
class CreatePostCardState extends State<CreatePostCard> {
  ...
  Future deleteStatus(int id, index) async {
    ...
    if (body == 1) {
      setState(() {
        profileComCount[widget.index]['count'] -= 1;
        idx = -1;
        //isDeleted.add("$id");
        profileReplyList.removeAt(widget.index);
                          ...
                          child: Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                          ...
                                          child: Row(
                                            children: <Widget>[
                                              ...
                                              Container(
                                                ...
                                                child: Text(
                                                    profileReplyList.length == 0
                                                        ? "0"
                                                        : "${profileReplyList[index]['count']}",
                                                    style: TextStyle(
                                                        fontFamily: 'Oswald',
                                                        fontWeight:
                                                            FontWeight.w300,
                                ...
                                profileReplyList.length == 0
                                    ? Container()
                                    : profileReplyList[index]['count'] == 0
                                        ? Container()
                                        : GestureDetector(
                                            onTap: () {
                                              Navigator.push(
