import 'package:chatapp_new/Forms/CreateGroupPostForm/CreateGroupPostForm.dart';
...
class CreateGroupPost extends StatefulWidget {
  final userData;
  final groupList;
  CreateGroupPost(this.userData, this.groupList);

  @override
  CreateGroupPostState createState() => CreateGroupPostState();
}
          ...
          child: Column(
            ...
            children: <Widget>[
              Column(
                ...
                //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  CreateGroupPostForm(widget.userData, widget.groupList),
                ],
              ),
              Container()
            ],
