...
class StatusReplyPage extends StatefulWidget {
  final comList;
  final statusID;
  final index;
  StatusReplyPage(this.comList, this.statusID, this.index);
  @override
  ReplyPageState createState() => ReplyPageState();
}

class ReplyPageState extends State<StatusReplyPage> {
  var repList;
  var userData;
  ...
  Future commentSend(index) async {
    ...
    if (res.statusCode == 200) {
      setState(() {
        repEditor.text = "";
        statusPostRepCount[index]['count'] += 1;
      ...
      repEditor.text = "";
      statusPostRepCount.removeAt(replyList.length - 1);
      replyList.removeAt(replyList.length - 1);
      statusPostRepCount[index]['count'] -= 1;
    }
