...
class User {
  ...
  User(
      ...
      this.email,
      this.gender,
      this.userType, this.verified, this.interestLists);
...
class IsFriend {
  ...
  IsFriend(this.id, this.reason);

  factory IsFriend.fromJson(Map<String, dynamic> json) => _$IsFriendFromJson(json);
  Map<String, dynamic> toJson() => _$IsFriendToJson(this);
}
...
class IsRequestSent {
  ...
  IsRequestSent(this.id, this.status, this.following_id);

  factory IsRequestSent.fromJson(Map<String, dynamic> json) => _$IsRequestSentFromJson(json);
  Map<String, dynamic> toJson() => _$IsRequestSentToJson(this);
}
