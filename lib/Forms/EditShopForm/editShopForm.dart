...
class EditShopFormState extends State<EditShopForm> {
  ...
  List<DropdownMenuItem<String>> _dropDownCategoryItems, _dropDownCountryItems;
  ...
  Future loadCategories() async {
    ...
    var response = await CallApi().getData3('getShopCategories');
  ...
  Future loadData() async {
    ...
    countryName = productList.shopDetails.location;
    print(countryName);
    ...
    for (int i = 0; i < catLength; i++) {
      if (catList[i]['id'] == id) {
        selectedCategory.add("${catList[i]['name']}");
        selectedCat = selectedCategory.toList();
        isOpen = false;
        selectedID = catList[i]['id'];
        cat = catList[i]['name'];
      }
    }
