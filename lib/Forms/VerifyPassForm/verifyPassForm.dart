...
import 'package:chatapp_new/MainScreen/ResetPasswordPage/resetPassPage.dart';
...
class VerifyPageFormState extends State<VerifyPageForm> {
  ...
  void _verifyEmailAdd() async {
    ...
    if (verificationController.text.isEmpty) {
      ...
      var data = {
        'passwordToken': verificationController.text,
      };

      //print(data);

      var res =
          await CallApi().postData(data, 'account/verfiyResetPasswordCode');
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: Text(
                          "Account has been successfully Verified. You can now reset your password.",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              color: Colors.black54,
                              fontSize: 14,
