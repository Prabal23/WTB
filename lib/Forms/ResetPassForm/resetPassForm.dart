...
class ResetPassForm extends StatefulWidget {
  final token;
  ResetPassForm(this.token);
  @override
  State<StatefulWidget> createState() {
    return ResetPassFormState();
  }
}
...
class ResetPassFormState extends State<ResetPassForm> {
  ...
  void _verifyEmailAdd() async {
    ...
    if (verificationController.text.isEmpty) {
      ...
      var data = {
        'password': verificationController.text,
        'token': widget.token,
      };

      //print(data);

      var res = await CallApi().postData(data, 'reset-password');
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: Text(
                          "Password has been successfully changed. Please login to your account",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              color: Colors.black54,
                              fontSize: 14,
